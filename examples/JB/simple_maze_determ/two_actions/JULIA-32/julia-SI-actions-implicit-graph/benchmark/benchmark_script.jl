...
folder = "./two_actions/JULIA_32/julia-SI-actions-implicit-graph"
...
function run_simulation(horizon, num_iterations)
    ...
    settings = @set settings.SI_observation_prune_threshold = .01#1/16  
    settings = @set settings.SI_policy_prune_threshold = .01#1/16
