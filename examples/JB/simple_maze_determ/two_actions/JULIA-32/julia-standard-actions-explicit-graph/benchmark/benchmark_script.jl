...
folder = "./two_actions/JULIA_32/julia-standard-actions-explicit-graph"
...
function run_simulation(horizon, num_iterations)
    ...
    parameters = @set parameters.gamma = 16.0  # use stochastic and high gamma to break ties for EFE over actions
    ...
    settings = @set settings.SI_policy_prune_threshold = 0.1 #1/16
