...
function ActiveInferenceCore.store_beliefs!(
    ...
    policy_posterior::NamedTuple{
        (:q_pi, :G, :predictions),
        Tuple{
            Vector{Float64},
            Vector{Float64},
            NamedTuple{
                (:all_predicted_states, :all_predicted_observations),
                Tuple{
    ...
    model.perceptual_process.predicted_states =
        policy_posterior.predictions.all_predicted_states
    model.perceptual_process.predicted_observations =
        policy_posterior.predictions.all_predicted_observations
...
function ActiveInferenceCore.store_beliefs!(
    ...
    if model.perceptual_process.D_learning !== nothing &&
       posterior.learning_posterior.D_updated !== nothing
...
function ActiveInferenceCore.store_beliefs!(
    ...
    model.perceptual_process.predicted_states =
        action_posterior.predictions.all_predicted_states
    model.perceptual_process.predicted_observations =
        action_posterior.predictions.all_predicted_observations
